...
- **[git-guardrails-claude-code](./git-guardrails-claude-code/SKILL.md)** — Set up Claude Code or Codex hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
